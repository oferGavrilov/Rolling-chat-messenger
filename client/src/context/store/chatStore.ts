...
interface ChatActions {
    ...
    setSelectedChat: (chat: IChat | null | ((currentChat: IChat | null) => IChat | null)) => void
...
export const createChatSlice = (set, get): IChatStore => ({
    ...
    setSelectedChat: (chat: IChat | null | ((currentChat: IChat | null) => IChat | null)) => {
        set((state: ChatState) => {
            const newChat = typeof chat === 'function'
