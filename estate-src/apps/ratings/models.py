...
class Rating(TimeStampedUUIDModel):
    ...
    rating = models.IntegerField(choices=Range.choices, verbose_name=_("Rating"), help_text="1=Poor, 2=Fair, 3=Good, 4=Very Good, 5=Excellent" ,default=0)
    ...
    def __str__(self):
        return f"{self.rater} rated {self.agent} {self.rating} stars"
